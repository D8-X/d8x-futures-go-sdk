...
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) GetDepositAmountForPredMktLvgPosition(opts *bind.CallOpts, _fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getDepositAmountForPredMktLvgPosition", _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkProb, _fS3, _fCmin)
...
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkProb, _fS3, _fCmin)
}

// GetDepositAmountForPredMktLvgPosition is a free data retrieval call binding the contract method 0x7270f154.
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkProb, _fS3, _fCmin)
}
...
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _varphi, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PmMaxTradeSize(opts *bind.CallOpts, _F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _varphi *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "pmMaxTradeSize", _F, _pnl, _mu0, _muM, _varphi, _a, _b)
...
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _varphi, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PmMaxTradeSize(_F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _varphi *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaxTradeSize(&_IPerpetualManager.CallOpts, _F, _pnl, _mu0, _muM, _varphi, _a, _b)
}

// PmMaxTradeSize is a free data retrieval call binding the contract method 0x8c4f3f87.
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _varphi, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PmMaxTradeSize(_F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _varphi *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaxTradeSize(&_IPerpetualManager.CallOpts, _F, _pnl, _mu0, _muM, _varphi, _a, _b)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0x4a7e4ab0.
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PrdMktsLvgFee(opts *bind.CallOpts, _fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "prdMktsLvgFee", _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee)
...
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerSession) PrdMktsLvgFee(_fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0x4a7e4ab0.
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PrdMktsLvgFee(_fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee)
}
...
// QueryPerpetualPrice is a free data retrieval call binding the contract method 0x32d046c0.
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[2] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) QueryPerpetualPrice(opts *bind.CallOpts, _iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [2]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[2] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) QueryPerpetualPrice(_iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [2]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
...
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[2] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) QueryPerpetualPrice(_iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [2]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
	return _IPerpetualManager.Contract.QueryPerpetualPrice(&_IPerpetualManager.CallOpts, _iPerpetualId, _fTradeAmountBC, _fIndexPrice, _confTbps, _params)
}
