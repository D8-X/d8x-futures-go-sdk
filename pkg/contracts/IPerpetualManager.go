...
//
// Solidity: function getPerpetual(uint24 _perpetualId) view returns((uint8,uint24,int32,int32,uint32,uint32,uint32,int32,uint8,uint8,uint16,bytes4,bytes4,uint16,uint16,bytes4,bytes4,int32,int32,uint16,(int128,uint64),int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int128,int32,int32,int32,uint32,int32,int128[2],int128[2],int128[2],int128[2]))
...
func (_IPerpetualManager *IPerpetualManagerTransactor) RemoveDelegate(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "removeDelegate")
}

// RemoveDelegate is a paid mutator transaction binding the contract method 0x36fb8b15.
//
// Solidity: function removeDelegate() returns()
func (_IPerpetualManager *IPerpetualManagerSession) RemoveDelegate() (*types.Transaction, error) {
	return _IPerpetualManager.Contract.RemoveDelegate(&_IPerpetualManager.TransactOpts)
}

// RemoveDelegate is a paid mutator transaction binding the contract method 0x36fb8b15.
//
// Solidity: function removeDelegate() returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) RemoveDelegate() (*types.Transaction, error) {
	return _IPerpetualManager.Contract.RemoveDelegate(&_IPerpetualManager.TransactOpts)
}
...
func (_IPerpetualManager *IPerpetualManagerTransactor) SetDelegate(opts *bind.TransactOpts, delegate common.Address) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "setDelegate", delegate)
}

// SetDelegate is a paid mutator transaction binding the contract method 0xca5eb5e1.
//
// Solidity: function setDelegate(address delegate) returns()
func (_IPerpetualManager *IPerpetualManagerSession) SetDelegate(delegate common.Address) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SetDelegate(&_IPerpetualManager.TransactOpts, delegate)
}

// SetDelegate is a paid mutator transaction binding the contract method 0xca5eb5e1.
//
// Solidity: function setDelegate(address delegate) returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) SetDelegate(delegate common.Address) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SetDelegate(&_IPerpetualManager.TransactOpts, delegate)
}
...
// UpdateFundingAndPricesBefore is a paid mutator transaction binding the contract method 0x5db898a2.
//
// Solidity: function updateFundingAndPricesBefore(uint24 _iPerpetualId) returns()
func (_IPerpetualManager *IPerpetualManagerTransactor) UpdateFundingAndPricesBefore(opts *bind.TransactOpts, _iPerpetualId *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "updateFundingAndPricesBefore", _iPerpetualId)
}

// UpdateFundingAndPricesBefore is a paid mutator transaction binding the contract method 0x5db898a2.
//
// Solidity: function updateFundingAndPricesBefore(uint24 _iPerpetualId) returns()
func (_IPerpetualManager *IPerpetualManagerSession) UpdateFundingAndPricesBefore(_iPerpetualId *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.UpdateFundingAndPricesBefore(&_IPerpetualManager.TransactOpts, _iPerpetualId)
}

// UpdateFundingAndPricesBefore is a paid mutator transaction binding the contract method 0x5db898a2.
//
// Solidity: function updateFundingAndPricesBefore(uint24 _iPerpetualId) returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) UpdateFundingAndPricesBefore(_iPerpetualId *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.UpdateFundingAndPricesBefore(&_IPerpetualManager.TransactOpts, _iPerpetualId)
}
...
// FilterSetDelegate is a free log retrieval operation binding the contract event 0xbeebfeebc9d1af8057ca45af36b2171fea34cb5b251e394f0bc5fcabde119d7f.
//
// Solidity: event SetDelegate(address trader, address delegate)
func (_IPerpetualManager *IPerpetualManagerFilterer) FilterSetDelegate(opts *bind.FilterOpts) (*IPerpetualManagerSetDelegateIterator, error) {

	logs, sub, err := _IPerpetualManager.contract.FilterLogs(opts, "SetDelegate")
	if err != nil {
		return nil, err
	}
...
// WatchSetDelegate is a free log subscription operation binding the contract event 0xbeebfeebc9d1af8057ca45af36b2171fea34cb5b251e394f0bc5fcabde119d7f.
//
// Solidity: event SetDelegate(address trader, address delegate)
func (_IPerpetualManager *IPerpetualManagerFilterer) WatchSetDelegate(opts *bind.WatchOpts, sink chan<- *IPerpetualManagerSetDelegate) (event.Subscription, error) {

	logs, sub, err := _IPerpetualManager.contract.WatchLogs(opts, "SetDelegate")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseSetDelegate is a log parse operation binding the contract event 0xbeebfeebc9d1af8057ca45af36b2171fea34cb5b251e394f0bc5fcabde119d7f.
//
// Solidity: event SetDelegate(address trader, address delegate)
