...
// GetDepositAmountForPredMktLvgPosition is a free data retrieval call binding the contract method 0x7270f154.
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) GetDepositAmountForPredMktLvgPosition(opts *bind.CallOpts, _fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getDepositAmountForPredMktLvgPosition", _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fS3, _fCmin)
...
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fS3, _fCmin)
}

// GetDepositAmountForPredMktLvgPosition is a free data retrieval call binding the contract method 0x7270f154.
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fS3, _fCmin)
}

// GetDepositAmtPrdMkt is a free data retrieval call binding the contract method 0xdb5fc9e9.
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) GetDepositAmtPrdMkt(opts *bind.CallOpts, _fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getDepositAmtPrdMkt", _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fS3, _fCmin)
...
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) GetDepositAmtPrdMkt(_fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmtPrdMkt(&_IPerpetualManager.CallOpts, _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fS3, _fCmin)
}

// GetDepositAmtPrdMkt is a free data retrieval call binding the contract method 0xdb5fc9e9.
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fS3, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetDepositAmtPrdMkt(_fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fS3 *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmtPrdMkt(&_IPerpetualManager.CallOpts, _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fS3, _fCmin)
}
...
// PmMaintenanceMarginCash is a free data retrieval call binding the contract method 0x7dcddf6f.
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate, int128 _fS3) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PmMaintenanceMarginCash(opts *bind.CallOpts, _pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int, _fS3 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "pmMaintenanceMarginCash", _pos, _entryProb, _markProb, _marginRate, _fS3)
...
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate, int128 _fS3) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PmMaintenanceMarginCash(_pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int, _fS3 *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaintenanceMarginCash(&_IPerpetualManager.CallOpts, _pos, _entryProb, _markProb, _marginRate, _fS3)
}

// PmMaintenanceMarginCash is a free data retrieval call binding the contract method 0x7dcddf6f.
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate, int128 _fS3) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PmMaintenanceMarginCash(_pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int, _fS3 *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaintenanceMarginCash(&_IPerpetualManager.CallOpts, _pos, _entryProb, _markProb, _marginRate, _fS3)
}
...
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PrdMktsLvgFee(opts *bind.CallOpts, _fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "prdMktsLvgFee", _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
...
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerSession) PrdMktsLvgFee(_fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0xa836d334.
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fPm, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PrdMktsLvgFee(_fPx *big.Int, _fPm *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fPm, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
}
