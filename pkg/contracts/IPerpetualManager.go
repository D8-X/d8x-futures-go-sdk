...
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fm, int128 _fTotLong, int128 _fTotShort, int128 _fTradeAmt, int128 _fMgnRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PrdMktsLvgFee(opts *bind.CallOpts, _fPx *big.Int, _fm *big.Int, _fTotLong *big.Int, _fTotShort *big.Int, _fTradeAmt *big.Int, _fMgnRate *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "prdMktsLvgFee", _fPx, _fm, _fTotLong, _fTotShort, _fTradeAmt, _fMgnRate)
...
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fm, int128 _fTotLong, int128 _fTotShort, int128 _fTradeAmt, int128 _fMgnRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PrdMktsLvgFee(_fPx *big.Int, _fm *big.Int, _fTotLong *big.Int, _fTotShort *big.Int, _fTradeAmt *big.Int, _fMgnRate *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fm, _fTotLong, _fTotShort, _fTradeAmt, _fMgnRate)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0x4a7e4ab0.
//
// Solidity: function prdMktsLvgFee(int128 _fPx, int128 _fm, int128 _fTotLong, int128 _fTotShort, int128 _fTradeAmt, int128 _fMgnRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PrdMktsLvgFee(_fPx *big.Int, _fm *big.Int, _fTotLong *big.Int, _fTotShort *big.Int, _fTradeAmt *big.Int, _fMgnRate *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fPx, _fm, _fTotLong, _fTotShort, _fTradeAmt, _fMgnRate)
}
