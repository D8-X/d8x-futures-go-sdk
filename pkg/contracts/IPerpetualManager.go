...
// CalcKappaEs is a free data retrieval call binding the contract method 0x3a2a0a8a.
//
// Solidity: function calcKappaEs(int128 _param, int128 _fp0, int128 _fRho, int128 _fp, int128 _fm, int128 _fm0) pure returns(int128 fKappa, int128 es)
func (_IPerpetualManager *IPerpetualManagerCaller) CalcKappaEs(opts *bind.CallOpts, _param *big.Int, _fp0 *big.Int, _fRho *big.Int, _fp *big.Int, _fm *big.Int, _fm0 *big.Int) (struct {
	FKappa *big.Int
	Es     *big.Int
}, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "calcKappaEs", _param, _fp0, _fRho, _fp, _fm, _fm0)
	...
	outstruct.FKappa = *abi.ConvertType(out[0], new(*big.Int)).(**big.Int)
	outstruct.Es = *abi.ConvertType(out[1], new(*big.Int)).(**big.Int)
...
//
// Solidity: function calcKappaEs(int128 _param, int128 _fp0, int128 _fRho, int128 _fp, int128 _fm, int128 _fm0) pure returns(int128 fKappa, int128 es)
func (_IPerpetualManager *IPerpetualManagerSession) CalcKappaEs(_param *big.Int, _fp0 *big.Int, _fRho *big.Int, _fp *big.Int, _fm *big.Int, _fm0 *big.Int) (struct {
	FKappa *big.Int
	Es     *big.Int
}, error) {
	return _IPerpetualManager.Contract.CalcKappaEs(&_IPerpetualManager.CallOpts, _param, _fp0, _fRho, _fp, _fm, _fm0)
}

// CalcKappaEs is a free data retrieval call binding the contract method 0x3a2a0a8a.
//
// Solidity: function calcKappaEs(int128 _param, int128 _fp0, int128 _fRho, int128 _fp, int128 _fm, int128 _fm0) pure returns(int128 fKappa, int128 es)
func (_IPerpetualManager *IPerpetualManagerCallerSession) CalcKappaEs(_param *big.Int, _fp0 *big.Int, _fRho *big.Int, _fp *big.Int, _fm *big.Int, _fm0 *big.Int) (struct {
	FKappa *big.Int
	Es     *big.Int
}, error) {
	return _IPerpetualManager.Contract.CalcKappaEs(&_IPerpetualManager.CallOpts, _param, _fp0, _fRho, _fp, _fm, _fm0)
...
// DecodeUint16Float is a free data retrieval call binding the contract method 0x80411aa8.
//
// Solidity: function decodeUint16Float(uint16 num) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) DecodeUint16Float(opts *bind.CallOpts, num uint16) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "decodeUint16Float", num)
...
//
// Solidity: function decodeUint16Float(uint16 num) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) DecodeUint16Float(num uint16) (*big.Int, error) {
	return _IPerpetualManager.Contract.DecodeUint16Float(&_IPerpetualManager.CallOpts, num)
}

// DecodeUint16Float is a free data retrieval call binding the contract method 0x80411aa8.
//
// Solidity: function decodeUint16Float(uint16 num) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) DecodeUint16Float(num uint16) (*big.Int, error) {
	return _IPerpetualManager.Contract.DecodeUint16Float(&_IPerpetualManager.CallOpts, num)
}
...
// GetAMMState is a free data retrieval call binding the contract method 0xf50231b6.
//
// Solidity: function getAMMState(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(int128[15])
func (_IPerpetualManager *IPerpetualManagerCaller) GetAMMState(opts *bind.CallOpts, _perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([15]*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getAMMState(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(int128[15])
func (_IPerpetualManager *IPerpetualManagerSession) GetAMMState(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([15]*big.Int, error) {
...
//
// Solidity: function getAMMState(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(int128[15])
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetAMMState(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([15]*big.Int, error) {
	return _IPerpetualManager.Contract.GetAMMState(&_IPerpetualManager.CallOpts, _perpetualId, _fIndexPrice)
}
...
// GetDepositAmountForPredMktLvgPosition is a free data retrieval call binding the contract method 0xa3429452.
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) GetDepositAmountForPredMktLvgPosition(opts *bind.CallOpts, _fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fCmin *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getDepositAmountForPredMktLvgPosition", _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fCmin)
...
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fCmin)
}

// GetDepositAmountForPredMktLvgPosition is a free data retrieval call binding the contract method 0xa3429452.
//
// Solidity: function getDepositAmountForPredMktLvgPosition(int128 _fPosition0, int128 _fCash0CC, int128 _fBalance0, int128 _fTradeAmount, int128 _fTargetLeverage, int128 _fTradeProb, int128 _fMarkPrice, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetDepositAmountForPredMktLvgPosition(_fPosition0 *big.Int, _fCash0CC *big.Int, _fBalance0 *big.Int, _fTradeAmount *big.Int, _fTargetLeverage *big.Int, _fTradeProb *big.Int, _fMarkPrice *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmountForPredMktLvgPosition(&_IPerpetualManager.CallOpts, _fPosition0, _fCash0CC, _fBalance0, _fTradeAmount, _fTargetLeverage, _fTradeProb, _fMarkPrice, _fCmin)
}

// GetDepositAmtPrdMkt is a free data retrieval call binding the contract method 0xdd1caebf.
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) GetDepositAmtPrdMkt(opts *bind.CallOpts, _fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fCmin *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getDepositAmtPrdMkt", _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fCmin)
...
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) GetDepositAmtPrdMkt(_fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmtPrdMkt(&_IPerpetualManager.CallOpts, _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fCmin)
}

// GetDepositAmtPrdMkt is a free data retrieval call binding the contract method 0xdd1caebf.
//
// Solidity: function getDepositAmtPrdMkt(int128 _fTradeAmountBC, int128 _fTargetLeverage, int128 _fTraderProb, int128 _fMarkProb, int128 _fCmin) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetDepositAmtPrdMkt(_fTradeAmountBC *big.Int, _fTargetLeverage *big.Int, _fTraderProb *big.Int, _fMarkProb *big.Int, _fCmin *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.GetDepositAmtPrdMkt(&_IPerpetualManager.CallOpts, _fTradeAmountBC, _fTargetLeverage, _fTraderProb, _fMarkProb, _fCmin)
}
...
// GetLiquidatableAccounts is a free data retrieval call binding the contract method 0x215f482b.
//
// Solidity: function getLiquidatableAccounts(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address[] unsafeAccounts)
func (_IPerpetualManager *IPerpetualManagerCaller) GetLiquidatableAccounts(opts *bind.CallOpts, _perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([]common.Address, error) {
	var out []interface{}
...
//
// Solidity: function getLiquidatableAccounts(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address[] unsafeAccounts)
func (_IPerpetualManager *IPerpetualManagerSession) GetLiquidatableAccounts(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([]common.Address, error) {
...
//
// Solidity: function getLiquidatableAccounts(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address[] unsafeAccounts)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetLiquidatableAccounts(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) ([]common.Address, error) {
	return _IPerpetualManager.Contract.GetLiquidatableAccounts(&_IPerpetualManager.CallOpts, _perpetualId, _fIndexPrice)
}
...
// GetMarginAccounts is a free data retrieval call binding the contract method 0x38b4b0c6.
//
// Solidity: function getMarginAccounts(uint24[] _perpetualIds, address _traderAddress) view returns((int128,int128,int128,int128)[])
func (_IPerpetualManager *IPerpetualManagerCaller) GetMarginAccounts(opts *bind.CallOpts, _perpetualIds []*big.Int, _traderAddress common.Address) ([]PerpStorageMarginAccount, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getMarginAccounts", _perpetualIds, _traderAddress)
...
//
// Solidity: function getMarginAccounts(uint24[] _perpetualIds, address _traderAddress) view returns((int128,int128,int128,int128)[])
func (_IPerpetualManager *IPerpetualManagerSession) GetMarginAccounts(_perpetualIds []*big.Int, _traderAddress common.Address) ([]PerpStorageMarginAccount, error) {
	return _IPerpetualManager.Contract.GetMarginAccounts(&_IPerpetualManager.CallOpts, _perpetualIds, _traderAddress)
}

// GetMarginAccounts is a free data retrieval call binding the contract method 0x38b4b0c6.
//
// Solidity: function getMarginAccounts(uint24[] _perpetualIds, address _traderAddress) view returns((int128,int128,int128,int128)[])
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetMarginAccounts(_perpetualIds []*big.Int, _traderAddress common.Address) ([]PerpStorageMarginAccount, error) {
	return _IPerpetualManager.Contract.GetMarginAccounts(&_IPerpetualManager.CallOpts, _perpetualIds, _traderAddress)
}
...
// GetNextLiquidatableTrader is a free data retrieval call binding the contract method 0x5742106f.
//
// Solidity: function getNextLiquidatableTrader(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address traderAddr)
func (_IPerpetualManager *IPerpetualManagerCaller) GetNextLiquidatableTrader(opts *bind.CallOpts, _perpetualId *big.Int, _fIndexPrice [3]*big.Int) (common.Address, error) {
	var out []interface{}
...
//
// Solidity: function getNextLiquidatableTrader(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address traderAddr)
func (_IPerpetualManager *IPerpetualManagerSession) GetNextLiquidatableTrader(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) (common.Address, error) {
...
//
// Solidity: function getNextLiquidatableTrader(uint24 _perpetualId, int128[3] _fIndexPrice) view returns(address traderAddr)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetNextLiquidatableTrader(_perpetualId *big.Int, _fIndexPrice [3]*big.Int) (common.Address, error) {
	return _IPerpetualManager.Contract.GetNextLiquidatableTrader(&_IPerpetualManager.CallOpts, _perpetualId, _fIndexPrice)
}
...
//
// Solidity: function getOraclePrice(bytes4[2] _baseQuote) view returns(int128, uint64)
func (_IPerpetualManager *IPerpetualManagerCaller) GetOraclePrice(opts *bind.CallOpts, _baseQuote [2][4]byte) (*big.Int, uint64, error) {
	var out []interface{}
...
//
// Solidity: function getOraclePrice(bytes4[2] _baseQuote) view returns(int128, uint64)
func (_IPerpetualManager *IPerpetualManagerSession) GetOraclePrice(_baseQuote [2][4]byte) (*big.Int, uint64, error) {
...
//
// Solidity: function getOraclePrice(bytes4[2] _baseQuote) view returns(int128, uint64)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetOraclePrice(_baseQuote [2][4]byte) (*big.Int, uint64, error) {
	return _IPerpetualManager.Contract.GetOraclePrice(&_IPerpetualManager.CallOpts, _baseQuote)
}
...
// GetPerpetualState is a free data retrieval call binding the contract method 0x23800ad5.
//
// Solidity: function getPerpetualState(uint24 _perpetualId) view returns(uint8)
func (_IPerpetualManager *IPerpetualManagerCaller) GetPerpetualState(opts *bind.CallOpts, _perpetualId *big.Int) (uint8, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "getPerpetualState", _perpetualId)
...
//
// Solidity: function getPerpetualState(uint24 _perpetualId) view returns(uint8)
func (_IPerpetualManager *IPerpetualManagerSession) GetPerpetualState(_perpetualId *big.Int) (uint8, error) {
	return _IPerpetualManager.Contract.GetPerpetualState(&_IPerpetualManager.CallOpts, _perpetualId)
}

// GetPerpetualState is a free data retrieval call binding the contract method 0x23800ad5.
//
// Solidity: function getPerpetualState(uint24 _perpetualId) view returns(uint8)
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetPerpetualState(_perpetualId *big.Int) (uint8, error) {
	return _IPerpetualManager.Contract.GetPerpetualState(&_IPerpetualManager.CallOpts, _perpetualId)
}

// GetPerpetualStaticInfo is a free data retrieval call binding the contract method 0x68805619.
//
// Solidity: function getPerpetualStaticInfo(uint24[] perpetualIds) view returns((uint24,address,int32,int32,uint8,uint8,bytes4,bytes4,bytes4,bytes4,int128,int128,bytes32[],bool[],int128,int128)[])
...
// GetTraderState is a free data retrieval call binding the contract method 0x8c8baa6d.
//
// Solidity: function getTraderState(uint24 _perpetualId, address _traderAddress, int128[3] _fIndexPrice) view returns(int128[11])
func (_IPerpetualManager *IPerpetualManagerCaller) GetTraderState(opts *bind.CallOpts, _perpetualId *big.Int, _traderAddress common.Address, _fIndexPrice [3]*big.Int) ([11]*big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getTraderState(uint24 _perpetualId, address _traderAddress, int128[3] _fIndexPrice) view returns(int128[11])
func (_IPerpetualManager *IPerpetualManagerSession) GetTraderState(_perpetualId *big.Int, _traderAddress common.Address, _fIndexPrice [3]*big.Int) ([11]*big.Int, error) {
...
//
// Solidity: function getTraderState(uint24 _perpetualId, address _traderAddress, int128[3] _fIndexPrice) view returns(int128[11])
func (_IPerpetualManager *IPerpetualManagerCallerSession) GetTraderState(_perpetualId *big.Int, _traderAddress common.Address, _fIndexPrice [3]*big.Int) ([11]*big.Int, error) {
	return _IPerpetualManager.Contract.GetTraderState(&_IPerpetualManager.CallOpts, _perpetualId, _traderAddress, _fIndexPrice)
}
...
// PmMaintenanceMarginCash is a free data retrieval call binding the contract method 0x3a913a36.
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PmMaintenanceMarginCash(opts *bind.CallOpts, _pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "pmMaintenanceMarginCash", _pos, _entryProb, _markProb, _marginRate)
...
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PmMaintenanceMarginCash(_pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaintenanceMarginCash(&_IPerpetualManager.CallOpts, _pos, _entryProb, _markProb, _marginRate)
}

// PmMaintenanceMarginCash is a free data retrieval call binding the contract method 0x3a913a36.
//
// Solidity: function pmMaintenanceMarginCash(int128 _pos, int128 _entryProb, int128 _markProb, int128 _marginRate) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PmMaintenanceMarginCash(_pos *big.Int, _entryProb *big.Int, _markProb *big.Int, _marginRate *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaintenanceMarginCash(&_IPerpetualManager.CallOpts, _pos, _entryProb, _markProb, _marginRate)
}

// PmMaxTradeSize is a free data retrieval call binding the contract method 0x8c4f3f87.
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _p, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PmMaxTradeSize(opts *bind.CallOpts, _F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _p *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "pmMaxTradeSize", _F, _pnl, _mu0, _muM, _p, _a, _b)
...
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _p, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PmMaxTradeSize(_F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _p *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaxTradeSize(&_IPerpetualManager.CallOpts, _F, _pnl, _mu0, _muM, _p, _a, _b)
}

// PmMaxTradeSize is a free data retrieval call binding the contract method 0x8c4f3f87.
//
// Solidity: function pmMaxTradeSize(int128 _F, int128 _pnl, int128 _mu0, int128 _muM, int128 _p, int128 _a, int128 _b) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PmMaxTradeSize(_F *big.Int, _pnl *big.Int, _mu0 *big.Int, _muM *big.Int, _p *big.Int, _a *big.Int, _b *big.Int) (*big.Int, error) {
	return _IPerpetualManager.Contract.PmMaxTradeSize(&_IPerpetualManager.CallOpts, _F, _pnl, _mu0, _muM, _p, _a, _b)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0xa836d334.
//
// Solidity: function prdMktsLvgFee(int128 _fP0, int128 _fWinProb, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PrdMktsLvgFee(opts *bind.CallOpts, _fP0 *big.Int, _fWinProb *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "prdMktsLvgFee", _fP0, _fWinProb, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
...
//
// Solidity: function prdMktsLvgFee(int128 _fP0, int128 _fWinProb, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerSession) PrdMktsLvgFee(_fP0 *big.Int, _fWinProb *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fP0, _fWinProb, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
}

// PrdMktsLvgFee is a free data retrieval call binding the contract method 0xa836d334.
//
// Solidity: function prdMktsLvgFee(int128 _fP0, int128 _fWinProb, int128 _fm, int128 _fMgnRate, int128 _param, int128 _fPerformanceFee, int128 _fRho) pure returns(int128, int128, int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PrdMktsLvgFee(_fP0 *big.Int, _fWinProb *big.Int, _fm *big.Int, _fMgnRate *big.Int, _param *big.Int, _fPerformanceFee *big.Int, _fRho *big.Int) (*big.Int, *big.Int, *big.Int, error) {
	return _IPerpetualManager.Contract.PrdMktsLvgFee(&_IPerpetualManager.CallOpts, _fP0, _fWinProb, _fm, _fMgnRate, _param, _fPerformanceFee, _fRho)
}

// PriceImpact is a free data retrieval call binding the contract method 0x2353388b.
//
// Solidity: function priceImpact(int128 _amount, uint64 _params) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) PriceImpact(opts *bind.CallOpts, _amount *big.Int, _params uint64) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "priceImpact", _amount, _params)
...
//
// Solidity: function priceImpact(int128 _amount, uint64 _params) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) PriceImpact(_amount *big.Int, _params uint64) (*big.Int, error) {
	return _IPerpetualManager.Contract.PriceImpact(&_IPerpetualManager.CallOpts, _amount, _params)
}

// PriceImpact is a free data retrieval call binding the contract method 0x2353388b.
//
// Solidity: function priceImpact(int128 _amount, uint64 _params) pure returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) PriceImpact(_amount *big.Int, _params uint64) (*big.Int, error) {
	return _IPerpetualManager.Contract.PriceImpact(&_IPerpetualManager.CallOpts, _amount, _params)
}
...
//
// Solidity: function queryMidPrices(uint24[] _perpetualIds, int128[] _idxPriceDataPairs) view returns(int128[])
func (_IPerpetualManager *IPerpetualManagerCaller) QueryMidPrices(opts *bind.CallOpts, _perpetualIds []*big.Int, _idxPriceDataPairs []*big.Int) ([]*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "queryMidPrices", _perpetualIds, _idxPriceDataPairs)
...
//
// Solidity: function queryMidPrices(uint24[] _perpetualIds, int128[] _idxPriceDataPairs) view returns(int128[])
func (_IPerpetualManager *IPerpetualManagerSession) QueryMidPrices(_perpetualIds []*big.Int, _idxPriceDataPairs []*big.Int) ([]*big.Int, error) {
	return _IPerpetualManager.Contract.QueryMidPrices(&_IPerpetualManager.CallOpts, _perpetualIds, _idxPriceDataPairs)
}

// QueryMidPrices is a free data retrieval call binding the contract method 0xa0b6e127.
//
// Solidity: function queryMidPrices(uint24[] _perpetualIds, int128[] _idxPriceDataPairs) view returns(int128[])
func (_IPerpetualManager *IPerpetualManagerCallerSession) QueryMidPrices(_perpetualIds []*big.Int, _idxPriceDataPairs []*big.Int) ([]*big.Int, error) {
	return _IPerpetualManager.Contract.QueryMidPrices(&_IPerpetualManager.CallOpts, _perpetualIds, _idxPriceDataPairs)
}

// QueryPerpetualPrice is a free data retrieval call binding the contract method 0xdd630dcc.
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[3] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerCaller) QueryPerpetualPrice(opts *bind.CallOpts, _iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [3]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
	var out []interface{}
	err := _IPerpetualManager.contract.Call(opts, &out, "queryPerpetualPrice", _iPerpetualId, _fTradeAmountBC, _fIndexPrice, _confTbps, _params)
...
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[3] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerSession) QueryPerpetualPrice(_iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [3]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
	return _IPerpetualManager.Contract.QueryPerpetualPrice(&_IPerpetualManager.CallOpts, _iPerpetualId, _fTradeAmountBC, _fIndexPrice, _confTbps, _params)
}

// QueryPerpetualPrice is a free data retrieval call binding the contract method 0xdd630dcc.
//
// Solidity: function queryPerpetualPrice(uint24 _iPerpetualId, int128 _fTradeAmountBC, int128[3] _fIndexPrice, uint16 _confTbps, uint64 _params) view returns(int128)
func (_IPerpetualManager *IPerpetualManagerCallerSession) QueryPerpetualPrice(_iPerpetualId *big.Int, _fTradeAmountBC *big.Int, _fIndexPrice [3]*big.Int, _confTbps uint16, _params uint64) (*big.Int, error) {
	return _IPerpetualManager.Contract.QueryPerpetualPrice(&_IPerpetualManager.CallOpts, _iPerpetualId, _fTradeAmountBC, _fIndexPrice, _confTbps, _params)
}
...
// ClearTradersInPool is a paid mutator transaction binding the contract method 0xa6e127fe.
//
// Solidity: function clearTradersInPool(uint8 _id, uint256 _bulkSize) returns(bool)
func (_IPerpetualManager *IPerpetualManagerTransactor) ClearTradersInPool(opts *bind.TransactOpts, _id uint8, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "clearTradersInPool", _id, _bulkSize)
}

// ClearTradersInPool is a paid mutator transaction binding the contract method 0xa6e127fe.
//
// Solidity: function clearTradersInPool(uint8 _id, uint256 _bulkSize) returns(bool)
func (_IPerpetualManager *IPerpetualManagerSession) ClearTradersInPool(_id uint8, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.ClearTradersInPool(&_IPerpetualManager.TransactOpts, _id, _bulkSize)
}

// ClearTradersInPool is a paid mutator transaction binding the contract method 0xa6e127fe.
//
// Solidity: function clearTradersInPool(uint8 _id, uint256 _bulkSize) returns(bool)
func (_IPerpetualManager *IPerpetualManagerTransactorSession) ClearTradersInPool(_id uint8, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.ClearTradersInPool(&_IPerpetualManager.TransactOpts, _id, _bulkSize)
}
...
// LiquidateByAMM is a paid mutator transaction binding the contract method 0x9b12de21.
//
// Solidity: function liquidateByAMM(uint24 _perpetualIndex, address _liquidatorAddr, address[] _traderAddr, bytes[] _updateData, uint64[] _publishTimes) payable returns()
...
// PreTrade is a paid mutator transaction binding the contract method 0x0dbc09a7.
//
// Solidity: function preTrade((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order, bool _isPred) returns(int128, int128)
func (_IPerpetualManager *IPerpetualManagerTransactor) PreTrade(opts *bind.TransactOpts, _order IPerpetualOrderOrder, _isPred bool) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "preTrade", _order, _isPred)
}

// PreTrade is a paid mutator transaction binding the contract method 0x0dbc09a7.
//
// Solidity: function preTrade((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order, bool _isPred) returns(int128, int128)
func (_IPerpetualManager *IPerpetualManagerSession) PreTrade(_order IPerpetualOrderOrder, _isPred bool) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.PreTrade(&_IPerpetualManager.TransactOpts, _order, _isPred)
}

// PreTrade is a paid mutator transaction binding the contract method 0x0dbc09a7.
//
// Solidity: function preTrade((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order, bool _isPred) returns(int128, int128)
func (_IPerpetualManager *IPerpetualManagerTransactorSession) PreTrade(_order IPerpetualOrderOrder, _isPred bool) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.PreTrade(&_IPerpetualManager.TransactOpts, _order, _isPred)
}
...
// ResetRedemptionRate is a paid mutator transaction binding the contract method 0xd57777e0.
//
// Solidity: function resetRedemptionRate(uint8 _poolId) returns()
func (_IPerpetualManager *IPerpetualManagerTransactor) ResetRedemptionRate(opts *bind.TransactOpts, _poolId uint8) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "resetRedemptionRate", _poolId)
}

// ResetRedemptionRate is a paid mutator transaction binding the contract method 0xd57777e0.
//
// Solidity: function resetRedemptionRate(uint8 _poolId) returns()
func (_IPerpetualManager *IPerpetualManagerSession) ResetRedemptionRate(_poolId uint8) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.ResetRedemptionRate(&_IPerpetualManager.TransactOpts, _poolId)
}

// ResetRedemptionRate is a paid mutator transaction binding the contract method 0xd57777e0.
//
// Solidity: function resetRedemptionRate(uint8 _poolId) returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) ResetRedemptionRate(_poolId uint8) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.ResetRedemptionRate(&_IPerpetualManager.TransactOpts, _poolId)
}
...
// SetMarginRates is a paid mutator transaction binding the contract method 0x55eda77c.
//
// Solidity: function setMarginRates(uint24 _iPerpetualId, int128 _fMaintenanceMarginRate, int128 _fInitialMarginRate) returns()
func (_IPerpetualManager *IPerpetualManagerTransactor) SetMarginRates(opts *bind.TransactOpts, _iPerpetualId *big.Int, _fMaintenanceMarginRate *big.Int, _fInitialMarginRate *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "setMarginRates", _iPerpetualId, _fMaintenanceMarginRate, _fInitialMarginRate)
}

// SetMarginRates is a paid mutator transaction binding the contract method 0x55eda77c.
//
// Solidity: function setMarginRates(uint24 _iPerpetualId, int128 _fMaintenanceMarginRate, int128 _fInitialMarginRate) returns()
func (_IPerpetualManager *IPerpetualManagerSession) SetMarginRates(_iPerpetualId *big.Int, _fMaintenanceMarginRate *big.Int, _fInitialMarginRate *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SetMarginRates(&_IPerpetualManager.TransactOpts, _iPerpetualId, _fMaintenanceMarginRate, _fInitialMarginRate)
}

// SetMarginRates is a paid mutator transaction binding the contract method 0x55eda77c.
//
// Solidity: function setMarginRates(uint24 _iPerpetualId, int128 _fMaintenanceMarginRate, int128 _fInitialMarginRate) returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) SetMarginRates(_iPerpetualId *big.Int, _fMaintenanceMarginRate *big.Int, _fInitialMarginRate *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SetMarginRates(&_IPerpetualManager.TransactOpts, _iPerpetualId, _fMaintenanceMarginRate, _fInitialMarginRate)
}
...
// SettleTraders is a paid mutator transaction binding the contract method 0x80c05af0.
//
// Solidity: function settleTraders(uint24 _perpetualID, uint256 _bulkSize) returns(uint256 _settled)
func (_IPerpetualManager *IPerpetualManagerTransactor) SettleTraders(opts *bind.TransactOpts, _perpetualID *big.Int, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "settleTraders", _perpetualID, _bulkSize)
}

// SettleTraders is a paid mutator transaction binding the contract method 0x80c05af0.
//
// Solidity: function settleTraders(uint24 _perpetualID, uint256 _bulkSize) returns(uint256 _settled)
func (_IPerpetualManager *IPerpetualManagerSession) SettleTraders(_perpetualID *big.Int, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SettleTraders(&_IPerpetualManager.TransactOpts, _perpetualID, _bulkSize)
}

// SettleTraders is a paid mutator transaction binding the contract method 0x80c05af0.
//
// Solidity: function settleTraders(uint24 _perpetualID, uint256 _bulkSize) returns(uint256 _settled)
func (_IPerpetualManager *IPerpetualManagerTransactorSession) SettleTraders(_perpetualID *big.Int, _bulkSize *big.Int) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.SettleTraders(&_IPerpetualManager.TransactOpts, _perpetualID, _bulkSize)
}

// Sponsor is a paid mutator transaction binding the contract method 0x77c93662.
//
// Solidity: function sponsor() payable returns()
func (_IPerpetualManager *IPerpetualManagerTransactor) Sponsor(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "sponsor")
}

// Sponsor is a paid mutator transaction binding the contract method 0x77c93662.
//
// Solidity: function sponsor() payable returns()
func (_IPerpetualManager *IPerpetualManagerSession) Sponsor() (*types.Transaction, error) {
	return _IPerpetualManager.Contract.Sponsor(&_IPerpetualManager.TransactOpts)
}

// Sponsor is a paid mutator transaction binding the contract method 0x77c93662.
//
// Solidity: function sponsor() payable returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) Sponsor() (*types.Transaction, error) {
	return _IPerpetualManager.Contract.Sponsor(&_IPerpetualManager.TransactOpts)
}
...
// IPerpetualManagerSettleV2Iterator is returned from FilterSettleV2 and is used to iterate over the raw logs and unpacked data for SettleV2 events raised by the IPerpetualManager contract.
type IPerpetualManagerSettleV2Iterator struct {
	Event *IPerpetualManagerSettleV2 // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *IPerpetualManagerSettleV2Iterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(IPerpetualManagerSettleV2)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *IPerpetualManagerSettleV2Iterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *IPerpetualManagerSettleV2Iterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// IPerpetualManagerSettleV2 represents a SettleV2 event raised by the IPerpetualManager contract.
type IPerpetualManagerSettleV2 struct {
	PerpetualId *big.Int
	Trader      common.Address
	Amount      *big.Int
	Cash        *big.Int
...
// FilterSettleV2 is a free log retrieval operation binding the contract event 0x5271b69bdf3e408747c2083e04617dc3c87feaad7b3741ab562313733e81c3a0.
//
// Solidity: event SettleV2(uint24 indexed perpetualId, address indexed trader, int256 amount, int128 cash)
func (_IPerpetualManager *IPerpetualManagerFilterer) FilterSettleV2(opts *bind.FilterOpts, perpetualId []*big.Int, trader []common.Address) (*IPerpetualManagerSettleV2Iterator, error) {
	...
	logs, sub, err := _IPerpetualManager.contract.FilterLogs(opts, "SettleV2", perpetualIdRule, traderRule)
	if err != nil {
		return nil, err
	}
	return &IPerpetualManagerSettleV2Iterator{contract: _IPerpetualManager.contract, event: "SettleV2", logs: logs, sub: sub}, nil
}

// WatchSettleV2 is a free log subscription operation binding the contract event 0x5271b69bdf3e408747c2083e04617dc3c87feaad7b3741ab562313733e81c3a0.
//
// Solidity: event SettleV2(uint24 indexed perpetualId, address indexed trader, int256 amount, int128 cash)
func (_IPerpetualManager *IPerpetualManagerFilterer) WatchSettleV2(opts *bind.WatchOpts, sink chan<- *IPerpetualManagerSettleV2, perpetualId []*big.Int, trader []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _IPerpetualManager.contract.WatchLogs(opts, "SettleV2", perpetualIdRule, traderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(IPerpetualManagerSettleV2)
				if err := _IPerpetualManager.contract.UnpackLog(event, "SettleV2", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseSettleV2 is a log parse operation binding the contract event 0x5271b69bdf3e408747c2083e04617dc3c87feaad7b3741ab562313733e81c3a0.
//
// Solidity: event SettleV2(uint24 indexed perpetualId, address indexed trader, int256 amount, int128 cash)
func (_IPerpetualManager *IPerpetualManagerFilterer) ParseSettleV2(log types.Log) (*IPerpetualManagerSettleV2, error) {
	event := new(IPerpetualManagerSettleV2)
	if err := _IPerpetualManager.contract.UnpackLog(event, "SettleV2", log); err != nil {
		return nil, err
	}
...
// FilterUpdateMarginAccount is a free log retrieval operation binding the contract event 0x356aeed3544046518a6b608778197714c91546134542d3e95937c66381571559.
//
// Solidity: event UpdateMarginAccount(uint24 indexed perpetualId, address indexed trader, int128 fLockedInValueQC, int128 fCashCC, int128 fPositionBC, int128 fFundingPaymentCC)
...
// WatchUpdateMarginAccount is a free log subscription operation binding the contract event 0x356aeed3544046518a6b608778197714c91546134542d3e95937c66381571559.
//
// Solidity: event UpdateMarginAccount(uint24 indexed perpetualId, address indexed trader, int128 fLockedInValueQC, int128 fCashCC, int128 fPositionBC, int128 fFundingPaymentCC)
...
// ParseUpdateMarginAccount is a log parse operation binding the contract event 0x356aeed3544046518a6b608778197714c91546134542d3e95937c66381571559.
//
// Solidity: event UpdateMarginAccount(uint24 indexed perpetualId, address indexed trader, int128 fLockedInValueQC, int128 fCashCC, int128 fPositionBC, int128 fFundingPaymentCC)
...
//
// Solidity: event UpdateMarkPrice(uint24 indexed perpetualId, int128 fMidPricePremium, int128 fMarkPricePremium, int128 fMarkIndexPrice)
