...
// TestTradeEvent is a paid mutator transaction binding the contract method 0x113a6ff8.
//
// Solidity: function testTradeEvent((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order) returns()
func (_IPerpetualManager *IPerpetualManagerTransactor) TestTradeEvent(opts *bind.TransactOpts, _order IPerpetualOrderOrder) (*types.Transaction, error) {
	return _IPerpetualManager.contract.Transact(opts, "testTradeEvent", _order)
}

// TestTradeEvent is a paid mutator transaction binding the contract method 0x113a6ff8.
//
// Solidity: function testTradeEvent((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order) returns()
func (_IPerpetualManager *IPerpetualManagerSession) TestTradeEvent(_order IPerpetualOrderOrder) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.TestTradeEvent(&_IPerpetualManager.TransactOpts, _order)
}

// TestTradeEvent is a paid mutator transaction binding the contract method 0x113a6ff8.
//
// Solidity: function testTradeEvent((uint16,uint16,uint24,address,uint32,address,uint32,uint32,uint32,address,int128,int128,int128,bytes) _order) returns()
func (_IPerpetualManager *IPerpetualManagerTransactorSession) TestTradeEvent(_order IPerpetualOrderOrder) (*types.Transaction, error) {
	return _IPerpetualManager.Contract.TestTradeEvent(&_IPerpetualManager.TransactOpts, _order)
}
