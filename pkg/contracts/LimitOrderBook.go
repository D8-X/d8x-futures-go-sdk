...
// LobFactory is a free data retrieval call binding the contract method 0x146bd6fd.
//
// Solidity: function lobFactory() view returns(address)
func (_LimitOrderBook *LimitOrderBookCaller) LobFactory(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _LimitOrderBook.contract.Call(opts, &out, "lobFactory")
	if err != nil {
		return *new(common.Address), err
	}
...
//
// Solidity: function lobFactory() view returns(address)
func (_LimitOrderBook *LimitOrderBookSession) LobFactory() (common.Address, error) {
	return _LimitOrderBook.Contract.LobFactory(&_LimitOrderBook.CallOpts)
}

// LobFactory is a free data retrieval call binding the contract method 0x146bd6fd.
//
// Solidity: function lobFactory() view returns(address)
func (_LimitOrderBook *LimitOrderBookCallerSession) LobFactory() (common.Address, error) {
	return _LimitOrderBook.Contract.LobFactory(&_LimitOrderBook.CallOpts)
}
...
// Initialize is a paid mutator transaction binding the contract method 0xc7520c3e.
//
// Solidity: function initialize(address _perpetualManagerAddr, uint24 _perpetualId, uint8 _iCancelDelaySec, address _lobFactory) returns()
func (_LimitOrderBook *LimitOrderBookTransactor) Initialize(opts *bind.TransactOpts, _perpetualManagerAddr common.Address, _perpetualId *big.Int, _iCancelDelaySec uint8, _lobFactory common.Address) (*types.Transaction, error) {
	return _LimitOrderBook.contract.Transact(opts, "initialize", _perpetualManagerAddr, _perpetualId, _iCancelDelaySec, _lobFactory)
}

// Initialize is a paid mutator transaction binding the contract method 0xc7520c3e.
//
// Solidity: function initialize(address _perpetualManagerAddr, uint24 _perpetualId, uint8 _iCancelDelaySec, address _lobFactory) returns()
func (_LimitOrderBook *LimitOrderBookSession) Initialize(_perpetualManagerAddr common.Address, _perpetualId *big.Int, _iCancelDelaySec uint8, _lobFactory common.Address) (*types.Transaction, error) {
	return _LimitOrderBook.Contract.Initialize(&_LimitOrderBook.TransactOpts, _perpetualManagerAddr, _perpetualId, _iCancelDelaySec, _lobFactory)
}

// Initialize is a paid mutator transaction binding the contract method 0xc7520c3e.
//
// Solidity: function initialize(address _perpetualManagerAddr, uint24 _perpetualId, uint8 _iCancelDelaySec, address _lobFactory) returns()
func (_LimitOrderBook *LimitOrderBookTransactorSession) Initialize(_perpetualManagerAddr common.Address, _perpetualId *big.Int, _iCancelDelaySec uint8, _lobFactory common.Address) (*types.Transaction, error) {
	return _LimitOrderBook.Contract.Initialize(&_LimitOrderBook.TransactOpts, _perpetualManagerAddr, _perpetualId, _iCancelDelaySec, _lobFactory)
}
...
// ResetOrders is a paid mutator transaction binding the contract method 0x755fbbe3.
//
// Solidity: function resetOrders(uint256 _n) returns()
func (_LimitOrderBook *LimitOrderBookTransactor) ResetOrders(opts *bind.TransactOpts, _n *big.Int) (*types.Transaction, error) {
	return _LimitOrderBook.contract.Transact(opts, "resetOrders", _n)
}

// ResetOrders is a paid mutator transaction binding the contract method 0x755fbbe3.
//
// Solidity: function resetOrders(uint256 _n) returns()
func (_LimitOrderBook *LimitOrderBookSession) ResetOrders(_n *big.Int) (*types.Transaction, error) {
	return _LimitOrderBook.Contract.ResetOrders(&_LimitOrderBook.TransactOpts, _n)
}

// ResetOrders is a paid mutator transaction binding the contract method 0x755fbbe3.
//
// Solidity: function resetOrders(uint256 _n) returns()
func (_LimitOrderBook *LimitOrderBookTransactorSession) ResetOrders(_n *big.Int) (*types.Transaction, error) {
	return _LimitOrderBook.Contract.ResetOrders(&_LimitOrderBook.TransactOpts, _n)
}
