...
//
// Solidity: function getLiquidityPool(uint8 _poolId) view returns((bool,uint8,uint8,int32,uint8,uint16,address,uint64,int32,address,int128,int128,int128,int128,int128,uint128,uint128,uint128))
...
//
// Solidity: function getLiquidityPools(uint8 _poolIdFrom, uint8 _poolIdTo) view returns((bool,uint8,uint8,int32,uint8,uint16,address,uint64,int32,address,int128,int128,int128,int128,int128,uint128,uint128,uint128)[])
